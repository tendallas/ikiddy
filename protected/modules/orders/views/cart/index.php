	...
	<table width="100%">
		...
		<tr>
			<td style="vertical-align:middle;" width="20px">
				<?php echo str_replace('class="thumbnail"', 'class="remove"', CHtml::link('&nbsp;', array('/orders/cart/remove', 'index'=>$index), array('class'=>'remove'))); ?>
			</td>
...
-							$method = 'eav_'.$attribute->name;
	...
	<div class="recount">
		...
		<span class="total_cart">Всего:</span>
		<span id="total">
...
<div class="has_background confirm_order">
	...
	<span id="orderTotalPrice" class="total_cart"><?php echo StoreProduct::formatPrice($totalPrice) ?></span>
